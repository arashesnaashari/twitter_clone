export default function Home({ isConnected }) {
  //http://dc1.yellownightmovie.online/dl15/arashM2/Movie.Sub/0/1400/03/Vertigo.1958/Vertigo.1958.720p.BluRay.2CH.x265.HEVC.SoftSub.NightMovie.mkv?key=1_uCyv9ztbj8nXuW0O8CAOZglmt1673703124&cdn=disable
  return (
    <>
            ...
            <section>
              <div className="w-3/4 mb-20">
                ...
                <li className="mb-6 text-2xl font-semibold">
                  ...
                  studying online with YouTube and documentation.
                </li>
                {/* <li className="mb-6 text-2xl font-semibold">
                  The reason I'm applying for this job is to gain experience
                  working as an employee in the workspace and develop myself. 
                </li> */}

                <li className="mb-6 text-2xl font-semibold">
                  The reason I'm applying for this job is to gain experience and
                  develop myself.
                </li>
              </div>
              <h1 className="text-5xl mb-16 border-black font-bold">
              ...
              <div className="w-3/4 flex flex-row">
                <section className=" mr-3 flex flex-col bg-white mb-8 rounded-2xl p-8 w-1/2">
                  <div className="flex flex-row items-center gap-2 ">
                    {/* 
                    https://quera.org/media/public/certificate/3af875237af14b1988586481aaa9da12.png*/}
                ...
                <section className="flex flex-col bg-white mb-8 rounded-2xl p-8 w-1/2">
                  <div className="flex flex-row items-center gap-2 ">
                    <a href="#">
                      <div
                        className="bg-no-repeat bg-cover w-24 h-24 bg-center rounded-xl"
                        style={{ backgroundImage: "url(/quera.png)" }}
                      ></div>
                    </a>
                    <div>
                      <h1 className="text-md">
                        Front-end Development with React bootcamp{" "}
                      </h1>
                      <span className="text-sm text-gray-400">
                        aug2022 ~ nov2022
                      </span>
