      ...
      <div className="col-span-2 border-x-2 border-zinc-600 scrollll ">
        <div className="flex flex-col items-center ">
          <div
            ...
            className="w-4/5 h-48 mb-3 rounded-md text-white text-4xl flex items-center justify-center"
          >
          ...
          <section className="mt-3 grid grid-cols-5 p-3 w-4/5 text-gray-300">
            <div className="col-span-2">
              <div className="flex flex-row items-center">
                <div
                  className="w-12 h-12 rounded-3xl bg-slate-50 mr-3"
                  style={{
                    backgroundImage: `url(${useer.profile})`,
                    color: "transparent",
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                ...
                <Link href={`/user/@${useer.username}`} className="text-md">
                  {`@` + useer.username}
                </Link>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 justify-items-end">
                ...
                {follow || userInfo1.userId == useer._id ? (
                  ...
                  <div
                    ...
                    className="p-1 rounded-md cursor-pointer text-blue-600 hover:bg-blue-600 hover:text-black text-md flex flex-col items-center"
                  >
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
          ...
          <section className="  mt-3 w-3/4 border-l-2 border-l-yellow-500 ">
            <p className="text-white pl-2">{useer.bio}</p>
          </section>
          <section className="mt-3 w-3/4 border-l-2 border-l-green-500 ">
            <p className="text-white pl-2">{useer.email}</p>
          </section>
          <section className="w-3/4 mt-3">
            {useer.posts.length > 0 &&
              useer.posts.map((p) => {
                return (
                  <PostCard
                    color={p.color}
                    username={useer.username}
                    profile={useer.profile}
                    like={p.like}
                    date={p.date}
                    bookmark={p.bookmark}
                    id={p._id}
